                        ...
                        <div className="col-6">
                            <div className="main-product-details">
                                <div className="border-bottom">
                                    <h3 className="title">
                                        Kids Headphones Bulk 10 Pack Muilti Colored For Students
                                    </h3>
                                </div>
                                ...
                                <div className="py-3">
                                    ...
                                    <div className="d-flex align-items-center gap-10 my-3">
                                        ...
                                        <a 
                                            ...
                                            onClick={
                                                () => 
                                                {navigator.clipboard.writeText("https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg")}
                                            }
                        ...
                        <div className="col-12">
                            ...
                            <div className="review-inner-wrapper">
                                ...
                                <div className="reviews mt-4">
                                    ...
                                    <p className="mt-3">
                                        We pride ourselves on being the language school with over 140 years of
                                         experience. Master languages with our immersive Berlitz Method today!
                                    </p>
                                </div>
                            </div>
                        </div>
